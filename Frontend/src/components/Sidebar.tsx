...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { icon: <LineChart size={20} />, label: 'CFP Tracker', path: '/cfp-tracker' },
    { icon: <UserCircle size={20} />, label: 'Profile', path: '/profile' },
    { icon: <BarChart2 size={20} />, label: 'Charts', path: '/charts' },
    { icon: <Lightbulb size={20} />, label: 'CFP Optimizer', path: '/optimizer' },
  ];
